...
class cldict(object):
	...
	def get(self, key, failobj=None):
		# XXX
		"""	I do not like the way this is done.	It returns "None", even if the
		key has never, ever been set before, when it should be raising either A a
		KeyError or B an AttributeError. Either way, this is wrong in my opinion.
		Perhaps this could be a feature you could turn on or off when
		Instantiating this object, but I don't this one bit.	
		"""
		# XXX
		try:
			return self[key]
